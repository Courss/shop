  ...
  <div class="nav" v-for="(item,index) in list" :key="index">
    <div class="all">
      ...
      <div class="right">
        ...
        <div class="seconde">
          <div class="seconde_l"><span style="color: #FF4D4F;">{{item.rating}}&nbsp</span><span>{{item.grades}}</span></div>
          <div class="seconde_r"><span>{{item.time}}&nbsp</span><span>{{item.juli}}</span></div>
        </div>
        <div class="thrid"><span>{{item.qisong}}&nbsp</span><span>{{item.price}}</span></div>

<template>
<div>
      <div class="nav" v-for="(item,index) in list" :key="index" @click="toShop">
    <div class="all">
      <div class="content">
      ...
      <div class="right">
        ...
        <div class="thrid"><span>{{item.qisong}} </span><span :style="{color: (item.price==='ÃâÅäËÍ·Ñ'? '#e16531':'#333')}">{{item.price}}</span></div>

<template>
  <div>
   ...
   <form action="#" class="search_form">
      ...
      <div class="all" @click="toShop">
      <div class="content">
         <div class="left"><img src="./1.jpg"></div>
      <div class="right">
        <div class="top"><span>福罗德汉堡</span></div>
        <div class="seconde">
          <div class="seconde_l"><span style="color: #FF4D4F;">4.8分 </span><span>月售845</span></div>
          <div class="seconde_r"><span>30分钟 </span><span>745m</span></div>
        </div>
        <div class="thrid"><span>起送￥15 </span><span>配送￥1</span></div>
        <div class="fouth"><span>"非常好吃，炸鸡酥脆"</span></div>
    ...
    <div class="all" @click="toShop">
      <div class="content">
         <div class="left"><img src="./2.jpg"></div>
      <div class="right">
        <div class="top"><span>派乐汉堡</span></div>
        <div class="seconde">
          <div class="seconde_l"><span style="color: #FF4D4F;">4.8分 </span><span>月售845</span></div>
          <div class="seconde_r"><span>30分钟 </span><span>745m</span></div>
        </div>
